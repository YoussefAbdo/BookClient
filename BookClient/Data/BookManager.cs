...
namespace BookClient.Data
{
    ...
    {
        // This is the base address of the service.
        ...
        public async Task<Book> Add(string title, string author, string genre)
        {
            ...
            HttpClient client = await GetClient();
            StringContent stringContent = new StringContent(JsonConvert.SerializeObject(book), Encoding.UTF8, "application/json");
        ...
        public async Task UpdateAsync(Book book)
        {
            ...
            HttpClient client = await GetClient();
            StringContent stringContent = new StringContent(JsonConvert.SerializeObject(book), Encoding.UTF8, "application/json");
            var respose = await client.PutAsync(Url + book.ISBN, stringContent);
        ...
        public async Task Delete(string isbn)
        {
            ...
            HttpClient client = await GetClient();
            var resposne = await client.DeleteAsync(Url + isbn);
        }
    }
}
